...
pkgdatadir = $(datadir)/flam3
pkgincludedir = $(includedir)/flam3
pkglibdir = $(libdir)/flam3
pkglibexecdir = $(libexecdir)/flam3
...
am__v_lt_0 = --silent
am__v_lt_1 = 
libflam3_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(srcdir)/flam3.pc.in COPYING compile config.guess config.sub \
...
AR = /home/michael/emsdk/upstream/emscripten/emar
AUTOCONF = autoconf
AUTOHEADER = autoheader
AUTOMAKE = automake-1.15
AWK = gawk
CC = /home/michael/emsdk/upstream/emscripten/emcc
CCDEPMODE = depmode=none
CFLAGS = -L../jpeg-6b -L../libxml2-2.9.0/.libs -I../jpeg-6b -I../libxml2-2.9.0 -s USE_ZLIB=1 -s USE_LIBPNG=1
CPP = /home/michael/emsdk/upstream/emscripten/emcc -E
...
LD = /home/michael/emsdk/upstream/emscripten/emcc
LDFLAGS = 
LIBOBJS = 
LIBS = -ljpeg -lpthread -lxml2 -lpng -lz 
...
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /home/michael/emsdk/upstream/bin/llvm-nm
NMEDIT = 
OBJDUMP = objdump
OBJEXT = o
OTOOL = 
...
PACKAGE_VERSION = 
PATH_SEPARATOR = :
RANLIB = /home/michael/emsdk/upstream/emscripten/emranlib
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/bash
STRIP = strip
...
abs_builddir = /home/michael/Developer/flam3
abs_srcdir = /home/michael/Developer/flam3
abs_top_builddir = /home/michael/Developer/flam3
abs_top_srcdir = /home/michael/Developer/flam3
ac_ct_AR = 
ac_ct_CC = /home/michael/emsdk/upstream/emscripten/emcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/michael/Developer/flam3/install-sh
...
libflam3.la: $(libflam3_la_OBJECTS) $(libflam3_la_DEPENDENCIES) $(EXTRA_libflam3_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libflam3_la_LINK) -rpath $(libdir) $(libflam3_la_OBJECTS) $(libflam3_la_LIBADD) $(LIBS)
...
flam3-animate$(EXEEXT): $(flam3_animate_OBJECTS) $(flam3_animate_DEPENDENCIES) $(EXTRA_flam3_animate_DEPENDENCIES) 
	@rm -f flam3-animate$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(flam3_animate_OBJECTS) $(flam3_animate_LDADD) $(LIBS)

flam3-convert$(EXEEXT): $(flam3_convert_OBJECTS) $(flam3_convert_DEPENDENCIES) $(EXTRA_flam3_convert_DEPENDENCIES) 
	@rm -f flam3-convert$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(flam3_convert_OBJECTS) $(flam3_convert_LDADD) $(LIBS)

flam3-genome$(EXEEXT): $(flam3_genome_OBJECTS) $(flam3_genome_DEPENDENCIES) $(EXTRA_flam3_genome_DEPENDENCIES) 
	@rm -f flam3-genome$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(flam3_genome_OBJECTS) $(flam3_genome_LDADD) $(LIBS)

flam3-render$(EXEEXT): $(flam3_render_OBJECTS) $(flam3_render_DEPENDENCIES) $(EXTRA_flam3_render_DEPENDENCIES) 
	@rm -f flam3-render$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(flam3_render_OBJECTS) $(flam3_render_LDADD) $(LIBS)

...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 308416,
    DYNAMIC_BASE = 5551296,
    DYNAMICTOP_PTR = 308256;
...
var wasmBinaryFile = 'flam3-animate.wasm';
...
var asmGlobalArg = {};
var asmLibraryArg = { "__clock_gettime": ___clock_gettime, "__lock": ___lock, "__map_file": ___map_file, "__syscall10": ___syscall10, "__syscall183": ___syscall183, "__syscall195": ___syscall195, "__syscall20": ___syscall20, "__syscall221": ___syscall221, "__syscall5": ___syscall5, "__syscall54": ___syscall54, "__syscall91": ___syscall91, "__unlock": ___unlock, "abort": _abort, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_longjmp": _emscripten_longjmp, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "getTempRet0": _getTempRet0, "invoke_i": invoke_i, "invoke_ii": invoke_ii, "invoke_iii": invoke_iii, "invoke_iiii": invoke_iiii, "invoke_iiiii": invoke_iiiii, "invoke_vi": invoke_vi, "invoke_vii": invoke_vii, "invoke_viiii": invoke_viiii, "invoke_viiiiiiiii": invoke_viiiiiiiii, "memory": wasmMemory, "nanosleep": _nanosleep, "pthread_attr_destroy": _pthread_attr_destroy, "pthread_attr_init": _pthread_attr_init, "pthread_attr_setdetachstate": _pthread_attr_setdetachstate, "pthread_create": _pthread_create, "pthread_exit": _pthread_exit, "pthread_join": _pthread_join, "saveSetjmp": _saveSetjmp, "setTempRet0": _setTempRet0, "sysconf": _sysconf, "table": wasmTable, "testSetjmp": _testSetjmp, "time": _time };
var asm = createWasm();
Module["asm"] = asm;
